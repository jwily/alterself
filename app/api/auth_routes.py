...
def login():
    ...
    if form.validate_on_submit():
        ...
        # user = User.query.filter(User.email == form.data['email']).options(
        #     joinedload(User.characters)).options(
        #     joinedload(User.items)).options(
        #     joinedload(User.profs)).options(
        #     joinedload(User.features)).options(
        #     joinedload(User.images)).first()
